    ...
    [
        pytest.param(
            ...
            MockNode(
                ...
                [
                    MockNode(
                        "var_modifier", [MockNode("identifier", text=b"x")], text=None
                    ),
        ...
        pytest.param(
            ...
            MockNode(
                "if_expression",
                [
                    MockNode("var_modifier", [MockNode("identifier", text=b"z")]),
        ...
        pytest.param(
            ...
            MockNode(
                "root",
                [
                    MockNode("var_modifier", [MockNode("identifier", text=b"v")]),
